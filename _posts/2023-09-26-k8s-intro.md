...
![](/230926/1.png){: width="600" height="500" }

### **전통적인 배포방식**

지금과는 많이 다른 예전의 배포방식은 하나의 물리 서버에서 여러개의 애플리케이션을 배포하고 실행하는 방법이였습니다. 규모가 작은 서비스의 경우 큰 문제가 없겠지만, 서비스의 규모가 커지면 커질수록 비교적 리소스를 많이 차지하는 애플리케이션이 증가했을것입니다. 
...
![](/230926/5.png){: width="600" height="500" }
...
![](/230926/6.png){: width="600" height="500" }
...
두 방식의 동작 차이는 describe deployment 명령으로도 확인할 수 있습니다.
...
![](/230926/7.png){: width="600" height="500" }
...
![](/230926/10.png){: width="600" height="500" }
...
![](/230926/12.png){: width="600" height="500" }
...
![](/230926/11.png){: width="600" height="500" }
...
![](/230926/13.png){: width="600" height="500" }
...
![](/230926/14.png){: width="600" height="500" }
